...
def update_crop(
    ...
    try:
        ...
        return CropResponse(
            ...
            water_stored=updated.water_stored,
            consecutive_stress_days=updated.consecutive_stress_days,
...
def simulate_day(
    ...
    try:
        updated = crop_service.simulate_day(
            crop_id, current_user["id"], temperature, rain, sun_hours, irrigation
        )
        return CropResponse(
            id=updated.id,
            name=updated.name,
    ...
    try:
        ...
        return [
            DailyConditionResponse(
                ...
                rain=h.rain,
                sun_hours=h.sun_hours,
                estimated_biomass=h.estimated_biomass,
            )
            for h in history
        ]
    except (CropNotFoundError, ResourceOwnershipError) as e:
